...
static ExtrusionPath make_wave_path(const Polyline &polyline, const Flow &flow)
{
    ...
    // Orca: ExtrusionPath stores a Polyline3; wave fronts are generated in 2D and
    // are laid down at the layer's own Z, so lift them with z = 0 like the rest of
    // the perimeter pipeline does.
