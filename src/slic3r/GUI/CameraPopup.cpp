   ...
   : PopupWindow(parent, wxBORDER_NONE | wxPU_CONTAINS_CONTROLS)
{
    ...
    m_custom_camera_input_confirm->SetBackgroundColor(wxColour(192, 96, 255));
    m_custom_camera_input_confirm->SetBorderColor(wxColour(192, 96, 255));
    ...
    auto url = wxString(L"https://github.com/NanashiTheNameless/OrcaSlicer/wiki/"); // Orca: neutral wiki link (vendor URL removed)
...
void CameraPopup::set_custom_cam_button_state(bool state)
{
    ...
    auto stateColour = state ? wxColour(170, 0, 0) : wxColour(192, 96, 255);
