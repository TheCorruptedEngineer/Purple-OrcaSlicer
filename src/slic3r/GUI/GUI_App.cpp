...
static void migrate_flatpak_legacy_datadir(const boost::filesystem::path &data_dir_path)
{
    ...
    boost::replace_first(legacy_data_dir_str, "io.github.nanashithenameless.OrcaSlicer", "io.github.orcaslicer.OrcaSlicer");
...
void GUI_App::UpdateDarkUI(wxWindow* window, bool highlited/* = false*/, bool just_font/* = false*/)
{
    ...
    if (m_is_dark_mode) {
        ...
        // * the background color of a button: #B13CFF  -- 73
        if (bg_col != orig_col) {
