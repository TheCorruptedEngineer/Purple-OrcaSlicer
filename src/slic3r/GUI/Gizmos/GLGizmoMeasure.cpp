...
void GLGizmoMeasure::show_face_face_assembly_common() {
    if (m_measure_mode == EMeasureMode::ONLY_ASSEMBLY && m_hit_different_volumes.size() == 2 &&
        ...
        m_imgui->disabled_begin(!(action.can_set_to_center_coincidence));
        {
            ...
            ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(177.f/255.f, 60.f/255.f, 255.f/255.f, 1.0));
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4(177.f/255.f, 60.f/255.f, 255.f/255.f, 1.00f));
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4(177.f/255.f, 60.f/255.f, 255.f/255.f, 1.00f));
