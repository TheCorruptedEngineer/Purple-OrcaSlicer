...
void GLGizmoMeshBoolean::on_render()
{
    ...
    ColorRGB tool_color = {177.f/255.f, 60.f/255.f, 255.f/255.f};
...
void GLGizmoMeshBoolean::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    auto selectable = [this](const std::string& label, bool selected, const ImVec2& size_arg) {
        ...
        if (selected || hovered) {
            ...
            ImGui::PushStyleColor(ImGuiCol_Button, { 177.f/255.f, 60.f/255.f, 255.f/255.f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 177.f/255.f, 60.f/255.f, 255.f/255.f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 177.f/255.f, 60.f/255.f, 255.f/255.f, 1.0f });
        }
        else {
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 177.f/255.f, 60.f/255.f, 255.f/255.f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 177.f/255.f, 60.f/255.f, 255.f/255.f, 1.0f });
