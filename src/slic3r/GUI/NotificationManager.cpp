	...
	, m_notification_start  (GLCanvas3D::timestamp_now())
{
    ...
    m_NormalColor = ImVec4(0.694f, 0.235f, 1.0f, 1); // ORCA Purple

	m_CurrentColor = m_NormalColor;   //Default

	m_WindowBkgColor = ImVec4(1, 1, 1, 1);
    m_TextColor      = ImVec4(.2f, .2f, .2f, 1.0f);
    m_HyperTextColor = ImVec4(0.694f, 0.235f, 1.0f, 1); // ORCA Purple
}
...
void NotificationManager::PopNotification::use_bbl_theme()
{
 ...
 //   OldStyle.Colors[ImGuiCol_Text]     = m_TextColor;
	...
	m_HyperTextColor = m_is_dark ? ImVec4(0.694f, 0.235f, 1.0f, 1) : ImVec4(0.694f, 0.235f, 1.0f, 1); // ORCA Purple
	m_HyperTextColorHover = m_is_dark ? ImVec4(192.f / 255.f, 96.f / 255.f, 255.f / 255.f, 1) : ImVec4(155.f / 255.f, 74.f / 255.f, 224.f / 255.f, 1); //#C060FF / #9B4AE0;
