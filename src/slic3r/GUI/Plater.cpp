...
void Sidebar::priv::flush_printer_sync(bool restart)
{
    ...
    //btn_sync_printer->SetBackgroundColorNormal((*counter_sync_printer & 1) ? "#F8F8F8" :"#B13CFF");
...
{
    StateColor not_synced_colour(std::pair<wxColour, int>(wxColour("#B13CFF"), StateColor::Normal));
    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(39 * wxGetApp().em_unit(), -1)), p(new priv(parent))
{
    ...
    // add printer
    {
        ...
        struct PanelColors {
            ...
            wxColour bg_focus  = "#E5D6FF";
            wxColour bd_normal = "#DBDBDB";
            wxColour bd_hover  = "#B13CFF";
            wxColour bd_focus  = "#B13CFF";
        };
        ...
        */
        ...
        StateColor btn_sync_bd_col(
                std::pair<wxColour, int>(wxColour("#B13CFF"), StateColor::Pressed),
    ...
    text_ctrl->Bind(wxEVT_SET_FOCUS, [this](wxFocusEvent& e) {
        ...
        p->m_search_bar->SetBorderColor(wxColour("#B13CFF"));
