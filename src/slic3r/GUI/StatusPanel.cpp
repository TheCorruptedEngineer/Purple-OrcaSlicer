...
static const wxColour BUTTON_HOVER_COL   = wxColour(177, 60, 255);
...
static const wxColour STAGE_TEXT_COL      = wxColour(177, 60, 255);
...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(177, 60, 255));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(177, 60, 255));
...
wxBoxSizer *StatusBasePanel::create_misc_control(wxWindow *parent)
{
    ...
    m_switch_fan->Bind(wxEVT_ENTER_WINDOW, [this](auto& e) {
        m_fan_panel->SetBackgroundColor(wxColour(177, 60, 255));
        });
...
wxBoxSizer* StatusBasePanel::create_filament_group(wxWindow* parent)
{
    ...
    m_title_filament_loading->SetForegroundColour(wxColour(142, 47, 191));
...
void StatusPanel::on_ams_guide(wxCommandEvent& event)
{
    ...
    wxString ams_wiki_url = "https://github.com/NanashiTheNameless/OrcaSlicer/wiki/";
