    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0xB13CFF, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#B13CFF", "#B13CFF"};
wxString btn_confirm[10]  = {"#DFDFDF", "#B13CFF", "#C060FF", "#B13CFF", "#B13CFF", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#9B2FD9", "#D070FF"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#B13CFF", "#B13CFF"};
