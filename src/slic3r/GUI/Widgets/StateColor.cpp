...
static std::map<wxColour, wxColour> gDarkColors{
    {"#B13CFF", "#8E2FBF"}, // rgb(177, 60, 255)    ORCA color (purple)
    {"#1F8EEA", "#B13CFF"}, // rgb(31, 142, 234)   ??? - ORCA changed dark mode to purple
    ...
    {"#C060FF", "#9B4AE0"}, // rgb(177, 60, 255)    Button Confirm Color hover | ORCA Color Hover
    ...
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#BFDCFF", "#3C2263"}, // rgb(191, 225, 222)  Dropdown checked item background color > ORCA color with %25 opacity
    {"#E5D6FF", "#322852"}, // rgb(229, 240, 238)  Combo / Dropdown focused background color > ORCA color with %10 opacity
};
